        ...
        mDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentPw.trim().length() ==0){
                    Toast.makeText(context,"Изменения были сохранены.",Toast.LENGTH_SHORT).show();
                }else{
                    if (currentPw.equals(mUser.getPassword())){
                        ...
                        if (newPw1.trim().length()==0){
                            Toast.makeText(context,"Пожалуйста, введите новый пароль.",Toast.LENGTH_SHORT).show();
                        }else if (! newPw1.equals(newPw2)){
                            Toast.makeText(context,"Пароль не совпадает.",Toast.LENGTH_SHORT).show();
                        }else{
                        ...
                        Toast.makeText(context,"Вы ввели неверный старый пароль.",Toast.LENGTH_SHORT).show();
                    }
                }
